...
type Flags = {
  ...
  ASSISTANT_RECIPE_ENABLED: boolean;
...
export function getFlags(): Flags {
  ...
  _flags = {
    ...
    ASSISTANT_ENDPOINT: String(extra.ASSISTANT_ENDPOINT || ''),
    ...
    ASSISTANT_RECIPE_ENABLED: toBool(extra.ASSISTANT_RECIPE_ENABLED, false),
